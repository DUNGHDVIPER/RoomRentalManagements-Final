...
public class CustomerRoomCatalog : ICustomerRoomCatalog
{
    private static List<RoomPublicDto> Data => new()
    {
        new RoomPublicDto
        {
            ...
            Images = new()
            {
                ...
                {
                    Url = "https://picsum.photos/seed/r1/800/600"
                }
            },
            Amenities = new()
            {
                new AmenityPublicDto { Name = "Wifi" },
                new AmenityPublicDto { Name = "Aircon" }
            }
        },
        ...
        new RoomPublicDto
        {
            ...
            Images = new()
            {
                new RoomImagePublicDto
                {
                    Url = "https://picsum.photos/seed/r2/800/600"
                }
            },
            Amenities = new()
            {
                new AmenityPublicDto { Name = "Parking" },
                new AmenityPublicDto { Name = "Gym" }
            }
        }
    };
    ...
    public Task<PagedResultDto<RoomPublicDto>> SearchAsync(FilterRoomDto filter, PagedRequestDto page)
    {
        ...
        PagedResultDto<RoomPublicDto> res =
            new(items, total, page.PageNumber, page.PageSize);
